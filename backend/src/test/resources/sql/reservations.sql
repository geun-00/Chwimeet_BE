...
VALUES
    ...
    -- 게시글 6에 대해 2명의 게스트가 같은 시간대 예약
    (8, NOW(), NOW(), NULL, NULL, '경기도 성남시', '분당동', NULL, 'DELIVERY', NULL, NULL, NOW() + INTERVAL 31 DAY, NOW() + INTERVAL 30 DAY, NULL, 'DELIVERY', NULL, 'PENDING_APPROVAL', 1, 6),
    (9, NOW(), NOW(), NULL, NULL, '경기도 성남시', '분당동', NULL, 'DELIVERY', NULL, NULL, NOW() + INTERVAL 31 DAY, NOW() + INTERVAL 30 DAY, NULL, 'DELIVERY', NULL, 'PENDING_APPROVAL', 3, 6);